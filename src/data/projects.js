...
export const projects = [
  {
    ...
    image: assetPath('/assets/dietify/hero.webp'), imageAlt: 'Dietify nutrition and daily health tracking app shown on a phone and tablet',
  ...
  },
  {
    ...
    image: assetPath('/assets/speak-and-translate/hero.webp'), imageAlt: 'Speak and Translate language app shown on blue and white mobile devices',
  ...
  },
  {
    ...
    image: assetPath('/assets/expenseflow/hero.webp'), imageAlt: 'ExpenseFlow financial dashboard shown across two dark mobile devices',
  ...
  },
  {
    ...
    image: assetPath('/assets/wos/hero.webp'), imageAlt: 'WOS restaurant operating system shown across an admin laptop, tablets, phone, and payment terminal',
