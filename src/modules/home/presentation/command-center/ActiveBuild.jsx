export default function ActiveBuild({ project }) {
  ...
  return (
    <section className="active-build panel" aria-labelledby="active-build-title">
      <div className="panel__header"><span>Featured system</span><span>01 / 01</span></div>
