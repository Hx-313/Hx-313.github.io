...
export default function HeroCanvas() {
  ...
  useEffect(() => {
    ...
    const CARD_DEFS = [
      { img: '/assets/logos/pet-care.webp', name: 'Pet Care',    tag: 'iOS · Android', accent: '#00f2fe', pos: [-2.7, 1.25, 0.2], scale: 0.9,  data: [.3, .6, .5, .8, .7] },
      { img: '/assets/logos/dietify.png', name: 'Dietify',     tag: 'Health',        accent: '#7c3aed', pos: [-1.95, 2.4, 0.1], scale: 0.88, data: [.3, .5, .6, .5, .7] },
      { img: '/assets/archive/expenseflow.webp', name: 'ExpenseFlow', tag: 'Finance',       accent: '#4facfe', pos: [-0.1, 2.85, 0.0], scale: 0.92, data: [.4, .5, .7, .6, .9] },
      { img: '/assets/logos/ebill-checker.png', name: 'eBill',       tag: 'Utilities',     accent: '#00f2fe', pos: [ 1.75, 2.4, 0.1], scale: 0.88, data: [.5, .4, .6, .5, .8] },
      { img: '/assets/logos/speak-and-translate.png', name: 'Translate',   tag: 'AI Voice',      accent: '#ff2fd0', pos: [ 2.7, 1.25, 0.2], scale: 0.9,  data: [.2, .5, .4, .7, .6] },
