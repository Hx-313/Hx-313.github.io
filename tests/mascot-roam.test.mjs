...
test('Mascots component includes active-page confinement, free flight, and collision argument skits', () => {
  const content = readFileSync(resolve('src/components/Mascots.jsx'), 'utf-8');

  assert.ok(content.includes('SPOT_COMMENTARY') || content.includes('PAGE_COMMENTARY'), 'Includes multi-spot contextual commentary');
