...
from new_product_launch_monitoring import monitor_launches
result = monitor_launches(mcp_data=<mcp_response>, output_dir="/round-{N}/data")
```
...
- Call `client.product_database`, post-filter in Python: `date_first_available >= threshold`
