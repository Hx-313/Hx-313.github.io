...
from asin_deep_dive_enrichment import enrich_asins
result = enrich_asins(mcp_data=<mcp_response>, output_dir="/round-{N}/data")
```
...
- Call `client.product_database` to get product details (price, reviews, rating, LQS, weight, dimensions, seller type)
