...
from product_sourcing_private_label import analyze_sourcing
result = analyze_sourcing(mcp_data=<mcp_response>, output_dir="/round-{N}/data")
```
...
- Call `client.product_database(include_keywords=[kw], categories=[cat], page_size=50)`
