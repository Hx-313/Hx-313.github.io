...
from brand_seller_intelligence import analyze_brand
result = analyze_brand(mcp_data=<mcp_response>, output_dir="/round-{N}/data")
```
...
- Call `client.product_database` to get brand product data
