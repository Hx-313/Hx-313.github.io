...
from competitive_landscape_analysis import analyze_landscape
result = analyze_landscape(mcp_data=<mcp_response>, output_dir="/round-{N}/data")
```
...
- Call `client.product_database(categories=[cat], include_keywords=[kw], page_size=50)`
