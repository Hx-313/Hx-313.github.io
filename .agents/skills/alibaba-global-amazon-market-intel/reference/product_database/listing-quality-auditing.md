...
from listing_quality_auditing import audit_listings
result = audit_listings(mcp_data=<mcp_response>, output_dir="/round-{N}/data")
```
...
- Call `keywords_by_asin` for ASINs with LQS below category average
