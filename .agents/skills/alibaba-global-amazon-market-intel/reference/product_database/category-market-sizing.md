...
from category_market_sizing import size_market
result = size_market(mcp_data=<mcp_response>, output_dir="/round-{N}/data")
```
...
- Call `client.product_database` for each market
