...
from pricing_strategy_elasticity import analyze_pricing
result = analyze_pricing(mcp_data=<mcp_response>, output_dir="/round-{N}/data")
```
...
- Call `client.product_database` to get price, sales, BSR, and review data
