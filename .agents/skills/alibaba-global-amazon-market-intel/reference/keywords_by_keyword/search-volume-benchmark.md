...
import sys
sys.path.insert(0, '/icbu-amazon-market-intel/scripts/keywords_by_keyword')
from benchmark_demand import benchmark_demand

result = benchmark_demand(
    mcp_data=<mcp_response>,
    product_concepts=["yoga mat", "resistance band", "foam roller"],  # 1–10 product concepts
    output_dir="/round-{N}/data",
    trend_lookback_days=365,   # Historical window for YoY trend (default 365 days)
)
