...
import sys
sys.path.insert(0, '/icbu-amazon-market-intel/scripts/historical_search_volume')
from yoy_growth import analyze_yoy_growth

result = analyze_yoy_growth(
    mcp_data=<mcp_response>,
    keywords=["yoga mat"],                          # 1–5 keywords
    years=[2024, 2025],                             # Years to compare (2–4 years)
    month_start=1,                                  # Comparison window start month (default 1)
    month_end=12,                                   # Comparison window end month (default 12)
