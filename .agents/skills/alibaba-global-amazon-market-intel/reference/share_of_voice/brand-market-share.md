...
from brand_market_share import analyze_brand_share
result = analyze_brand_share(mcp_data=<mcp_response>, output_dir="/round-{N}/data")
```
...
- Call `client.share_of_voice(keyword=kw, marketplace=...)` to get brand SOV data per keyword
