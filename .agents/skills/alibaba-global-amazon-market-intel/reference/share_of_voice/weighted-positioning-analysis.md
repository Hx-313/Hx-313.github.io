...
from weighted_positioning_analysis import analyze_positioning
result = analyze_positioning(mcp_data=<mcp_response>, output_dir="/round-{N}/data")
```
...
- Call `client.share_of_voice(keyword=kw, marketplace=...)` to get SOV data
