...
import sys
sys.path.insert(0, '/icbu-amazon-market-intel/scripts/share_of_voice')
from keyword_competitive_intel import analyze_keyword_competition
result = analyze_keyword_competition(mcp_data=<mcp_response>, output_dir="/round-{N}/data")
```
...
- Call `client.share_of_voice(keyword=kw, marketplace=...)` to get brand SOV data
