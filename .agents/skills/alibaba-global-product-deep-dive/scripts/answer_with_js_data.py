...
_DIMENSION_DATA_MAP: dict[str, list[str]] = {
    ...
    # NOTE: ppc_analysis / traffic_structure kept for backward compatibility but
    # should be interpreted as B2B pricing analysis, NOT Amazon ad strategy.
    'ppc_analysis': ['keywords_market.csv', 'market_concentration.csv'],
    'traffic_structure': ['market_concentration.csv', 'keywords_market.csv'],
    # GGS v3+ dimensions
    'buyer_market_compliance': ['competitors.csv', 'keywords_market.csv'],
    'alibaba_supply_density': ['keywords_market.csv'],  # populated from product_supplier_search
    ...
    # marketing_traffic = B2B pricing & buyer market analysis (NOT Amazon ad strategy)
    'marketing_traffic': ['keywords_market.csv', 'market_concentration.csv'],
    'marketing': ['keywords_market.csv', 'market_concentration.csv'],
    'buyer_market': ['competitors.csv', 'keywords_market.csv'],
    'compliance': ['competitors.csv'],
    'alibaba_supply': ['keywords_market.csv'],
